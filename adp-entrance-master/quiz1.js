var app = new Vue({
    ...
    methods:{
        ...
        //   for(i=0; i<4; i++){
        //       return `{<button v-on:click='score_handler' v-for='(data,index) in quizzes' v-if='index===0'>
        //                 {{data.questions[0].answers[`+i+`].content}}
        //                 </button>}`
        //   }
        // },
        addToCart: function(){
